...
export const UserDropdown = ({ visible, onCloseDropdown }: UserDropdownProps) => {
  if (!visible) return null;

  return (
    <div className="absolute z-[999] right-8 top-[60px] p-[10px] bg-white border rounded-s-sm shadow-md">
      <Link
        href="/pengaturan-akun"
